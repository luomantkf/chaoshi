<%@ page contentType="text/html; charset=utf-8"%>
 ...
 function deleteManager(date) {
  if(confirm("确定要删除吗？")){
    window.location="/FgUserServlet.do?action=2&id="+date;
	}
  }
 </script>
<html>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        <div>
            <div class="optitle clearfix">
                <div class="title" align="left">前台用户管理&gt;&gt;</div>
            </div>
        </div>
        <div class="content">
...
<script id="test" type="text/html">
    <tr bgcolor="#6495ed">
        <td height="25" width="92">数据编号</td>
        <td width="102">用户名</td>
        <td width="82">年级</td>
        <td width="92">宿舍</td>
        <td width="152">联系方式</td>
        <td width="92">操作</td>
    </tr>
    ...
    <tr>
        ...
        <td><div align="center">{{value.grade}}</div></td>
        <td><div align="center">{{value.sushe}}</div></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        page("/FgUserServlet.do?action=4");})
</script>
</body>
</html>
